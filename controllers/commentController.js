...
const commentInfo = asyncHandler(async (req, res) => {
    ...
    try {
        ...
        res.render('tweet_details', { tweet_data: tweet, post_date: post_at,comments:sel_comments,comment_at:comment_post_dates,fuser:followuser,followers:getfollowerId});
        return;
    } catch (err) {
